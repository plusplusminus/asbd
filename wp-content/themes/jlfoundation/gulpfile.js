...
var project 		= 'jlfoundation', // Project name, used for build zip.
	url 		= 'localhost/jlfoundation', // Local Development URL for BrowserSync. Change as-needed.
...
gulp.task('vendorsJs', function() {
	return 	gulp.src([
				...
				bower+'/waypoints/lib/shortcuts/sticky.js'])
