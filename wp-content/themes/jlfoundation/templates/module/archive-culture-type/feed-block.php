<?php global $post; ?>
<?php $meta1 = get_post_meta($post->ID,'_jlfoundation_culture_item_meta_1',1); ?>
<?php $meta2 = get_post_meta($post->ID,'_jlfoundation_culture_item_meta_2',1); ?>
<?php $item_link = get_post_meta($post->ID,'_jlfoundation_culture_item_link',1); ?>
<?php $term_list = wp_get_post_terms($post->ID, 'culture-type' , array("fields" => "all")); ?>
<?php 
...
<article class="article-block article-block--<?php echo $term_list_slug; ?>">
